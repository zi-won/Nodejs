...
var users = [
  {
    ...
    username: 'jiwon',
    password:
      'aUtt4OWG/wHtHz675PqYuHXbT3+ASN+Tkc9/8Jtmj/caf+JectaKpeqBoFu2tT04li1KKTRIYTIbrxoshlbHbQnBAGrQ+Fz1trm9nM7i4yKpS/IUdGbX0DVGcuwYnNH9Hh++ZiubQTDIt1T4MmOncBPhxH3btPORqKEN0y2Ksjc=',
...
passport.deserializeUser(function (username, done) {
  ...
  var user = users.find((u) => u.authId === username);
  done(null, user);
});
